...
QCC:
OPS SUMMARY: krewes.keys() returns the keys in krewes.
random.choice randomly selects one of the keys.
l is the length of the selected key.
Then, a random index is selected based on l.
It returns a random devo.
"""
